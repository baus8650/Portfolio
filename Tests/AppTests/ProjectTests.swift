...
final class ProjectTests: XCTestCase {
    ...
    func testProjectsCanBeRetrievedFromAPI() throws {
        let project1 = Project(name: testProject1.name, yearCompleted: testProject1.yearCompleted)
        try project1.save(on: app.db).wait()
        
        let project2 = Project(name: testProject2.name, yearCompleted: testProject2.yearCompleted)
    ...
    func testProjectCanBeSavedWithAPI() throws {
        let project = Project(id: testProject1.id, name: testProject1.name, yearCompleted: testProject1.yearCompleted)
    ...
    func testUpdatingAProject() throws {
        ...
        let updatedProjectData = Project(id: project1.id, name: newName, yearCompleted: project1.yearCompleted)
    ...
    func testProjectCanBeDeletedWithAPI() throws {
        let project1 = Project(id: testProject1.id, name: testProject1.name, yearCompleted: testProject1.yearCompleted)
        try project1.save(on: app.db).wait()
        
        let project2 = Project(id: testProject2.id, name: testProject2.name, yearCompleted: testProject2.yearCompleted)
        try project2.save(on: app.db).wait()
